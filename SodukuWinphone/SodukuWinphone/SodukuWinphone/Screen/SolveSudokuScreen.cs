...
namespace SudokuWinphone
{
    class SolveSudokuScreen : GameScreen
    {
        ...
        public SolveSudokuScreen()
        {
            ...
            m_lockMatrixNumber = m_sudoku;
            m_solveSudoku = new Sudoku.Sudoku(1);
        ...
        public void getSelectnumber()
        {
            ...
            if (x > 9 && x < 11)
            {
                ...
                m_solveSudoku.m_Sudoku[(int)m_yselect, (int)m_xselect] = m_getstring;
            }
        }
        //Get Level Of Map
        ...
        public void EventButton()
        {
            ...
            if (m_v2.X > 570 && m_v2.X < 630)
            {
                if (m_v2.Y > 80 && m_v2.Y < 140)
                {
                    if (m_solveSudoku.FlagCheckResult() == true)
                    {
                    ...
                    if (m_solveSudoku.FlagCheckResult() == false)
                    {
                        m_flagWrongMsg = true;
